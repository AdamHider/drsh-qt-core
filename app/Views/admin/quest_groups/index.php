            ...
            <?php foreach ($quest_groups as $quest_group): ?>
                <li class="list-group-item">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="ms-auto">
                            <a href="/admin/quest_groups/form/<?= $quest_group['id'] ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i> Изменить</a>
                            <a href="/admin/quest_groups/delete/<?= $quest_group['id'] ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Удалить</a>
                        </div>
                    </div>
                </li>
            <?php endforeach; ?>
